...
#   r"--user-data-dir=C:\Users\shubham.thakur\AppData\Local\Google\Chrome\User Data"
# )
chromeOptions.add_argument("--profile-directory=Guest Profile")
chromeOptions.add_argument("--disable-extensions")

driver = webdriver.Chrome(
    executable_path=r"C:\Users\shubham.thakur\Documents\chromedriver.exe",
...
max_page = int(
    driver.find_element_by_class_name("andes-pagination__page-count").text.split()[-1]
)
